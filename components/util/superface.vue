<template>
	<view class="superface emoji" :class="'emoji--'+face">
		<view class="emoji__hand" v-if="face=='like'">
			<view class="emoji__thumb"></view>
		</view>
		<view class="emoji__heart" v-else-if="face=='love'"></view>
		<view class="emoji__face" v-else>
			<view class="emoji__eyes" v-if="face=='haha'"></view>
			<view class="emoji__eyebrows" v-else></view>
			<view class="emoji__eyes" v-if="face=='wow' || face=='sad' || face=='angry'"></view>
			<view class="emoji__mouth">
				<view class="emoji__tongue" v-if="face=='haha'"></view>
			</view>
		</view>
	</view>
</template>
...
<style>
	...
	.superface .emoji{transform: scale(0.5); margin: -16px;}
</style>
